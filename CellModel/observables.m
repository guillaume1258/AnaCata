...
o.r_tot = + S.rm_r + S.rm_t + S.rm_m  + S.rm_q + S.rm_p ...
          + S.zm_r + S.zm_t + S.zm_m  + S.zm_q + S.zm_p;
...
o.r_fraction           = o.ribosome_mass(end) / o.proteic_mass(end);
o.r_free_fraction      = S.e_r * k.n.r ./ o.proteic_mass(end);
o.t_fraction           = S.e_t * k.n.t ./ o.proteic_mass(end);
o.m_fraction           = S.e_m * k.n.m ./ o.proteic_mass(end);
o.q_fraction           = S.e_q * k.n.q ./ o.proteic_mass(end);

% lambda
k.K.gamma    = k.gamma_max / k.K.p * alpha;
o.gamma      = Hill(1 , k.K.gamma , k.gamma_max , S.a(end));                                           % Translation elongation rate
rate_tot     = (S.rm_r(end) + S.rm_t(end) + S.rm_m(end) + S.rm_q(end)) * o.gamma;  % Total polymerisation rate
